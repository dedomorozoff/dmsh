...
#cgo linux LDFLAGS: ${SRCDIR}/../../third_party/llama.cpp/build/src/libllama.a ${SRCDIR}/../../third_party/llama.cpp/build/ggml/src/libggml.a ${SRCDIR}/../../third_party/llama.cpp/build/ggml/src/libggml-base.a ${SRCDIR}/../../third_party/llama.cpp/build/ggml/src/libggml-cpu.a ${SRCDIR}/../../third_party/llama.cpp/build/ggml/src/ggml-cuda/libggml-cuda.a -lm -lstdc++ -lpthread -ldl -lgomp -lcudart_static -lcublas_static -lcublasLt_static -lcuda -lrt -ldl -lpthread
#cgo windows LDFLAGS: ${SRCDIR}/../../third_party/llama.cpp/build/src/libllama.a ${SRCDIR}/../../third_party/llama.cpp/build/ggml/src/ggml.a ${SRCDIR}/../../third_party/llama.cpp/build/ggml/src/ggml-base.a ${SRCDIR}/../../third_party/llama.cpp/build/ggml/src/ggml-cpu.a ${SRCDIR}/../../third_party/llama.cpp/build/ggml/src/ggml-cuda/ggml-cuda.a -lstdc++ -lgomp -lcudart -lcublas -lcuda
