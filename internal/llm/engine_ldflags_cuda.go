...
//
// Windows CUDA CI uses MSVC (MinGW cannot link the CUDA toolkit). Libs are
// the multi-config Release outputs from the Visual Studio cmake generator.
...
#cgo windows LDFLAGS: ${SRCDIR}/../../third_party/llama.cpp/build/src/Release/llama.lib ${SRCDIR}/../../third_party/llama.cpp/build/ggml/src/Release/ggml.lib ${SRCDIR}/../../third_party/llama.cpp/build/ggml/src/Release/ggml-base.lib ${SRCDIR}/../../third_party/llama.cpp/build/ggml/src/Release/ggml-cpu.lib ${SRCDIR}/../../third_party/llama.cpp/build/ggml/src/ggml-cuda/Release/ggml-cuda.lib cudart.lib cublas.lib cublasLt.lib cuda.lib advapi32.lib
